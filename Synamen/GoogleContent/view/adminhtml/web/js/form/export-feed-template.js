define(
    [
        ...
        'Synamen_GoogleContent/js/lib/codemirror',
        'Synamen_GoogleContent/data/data',
        'Synamen_GoogleContent/js/lib/show-hint',
        'Synamen_GoogleContent/js/lib/xml-hint',
        'Synamen_GoogleContent/js/lib/xml'
    ],
